        ...
        <div class="document-writers-grid">
            ...
            <div class="document-writer">
                ...
                <div class="writer-info">
                    <h3>Saurabh Kothari</h3>
                    <p>Experience: 5 years</p>
                    <p>Rating: 4.5</p>
                    <p>Service Charge: ₹1500</p>
                    <p>City: Ahmedabad</p>
                     <a href="form.php"><button class="book-appointment"> Book Appointment </button></a>
                </div>
            </div>
            ...
            <div class="document-writer">
                ...
                <div class="writer-info">
                    <h3>Raman Tripathi</h3>
                    <p>Experience: 10 years</p>
                    
                    <p>Rating: 4.9</p>
                    <p>Service Charge: ₹3500</p>
                    <p>City: Mumbai</p>
                    <button class="book-appointment">Book Appointment</button>
                </div>
            </div>
